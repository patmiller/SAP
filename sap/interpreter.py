...
class Interpreter(object):
    ...
    def IFACatenate(self,m,n,*args): raise NotImplementedError("IFACatenate")
    ...
    def IFRestValues(self,m,n,*args): raise NotImplementedError("IFRestValues")
    ...
    def IFReplaceMulti(self,m,n,*args): raise NotImplementedError("IFReplaceMulti")
    def IFConvert(self,m,n,*args): raise NotImplementedError("IFConvert")
    def IFCallForeign(self,m,n,*args): raise NotImplementedError("IFCallForeign")
    ...
    def IFGreat(self,m,n,a,b): return a > b
    def IFGreatEqual(self,m,n,a,b): return a >= b
    def IFAnd(self,m,n,*args):
        for x in args:
            if not x: return (False,)
        return (True,)
    def IFOr(self,m,n,*args):
        for x in args:
            if x: return (True,)
        return (False,)
